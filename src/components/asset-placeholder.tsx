...
export default function AssetPlaceholder({
  ...
  return (
    <div
      className={`relative flex flex-col items-center justify-center gap-2 overflow-hidden border-2 border-dashed border-[var(--anc-ink)]/20 bg-white px-6 text-center shadow-[0_20px_40px_-30px_rgba(11,17,32,.35)] ${className}`}
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            "repeating-linear-gradient(135deg, transparent 0 12px, rgba(11,17,32,.04) 12px 24px)",
        }}
        aria-hidden="true"
      />
      <p className="relative font-mono text-[11px] font-bold uppercase tracking-[.16em] text-[var(--anc-cerise-deep)]">
        {label}
      </p>
