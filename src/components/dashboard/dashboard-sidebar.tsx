...
export default function DashboardSidebar({
  ...
  const panelClass =
    "flex h-full flex-col border border-white/10 bg-[#101010]/70 backdrop-blur-2xl shadow-[0_0_60px_-15px_rgba(255,32,110,.35)]";
        ...
        <div className={panelClass}>
          ...
          <div className="mt-auto flex flex-col gap-3 px-3 pb-4">
            ...
            <div className="flex items-center gap-3 rounded-xl px-2 py-1.5">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#FF206E] to-[#5C0C2E] text-xs font-black text-[#120d1b]">
              ...
              {collapsed ? null : (
                <div className="min-w-0 flex-1">
                  ...
                  <form action="/auth/signout" method="post">
                    <button type="submit" className="text-xs text-neutral-500 transition hover:text-[#FF6FA0]">
                      Cerrar sesión
                    </button>
                  </form>
                </div>
