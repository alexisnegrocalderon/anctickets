      ...
      <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-x-4 gap-y-2 px-4 py-4">
        ...
        <nav className="flex flex-wrap items-center gap-x-4 gap-y-2 font-mono text-xs font-semibold uppercase tracking-[.1em] text-neutral-300">
          <Link
            href="/"
            data-cursor-hover
            className="transition duration-100 hover:text-[#c3adff] active:text-[#a77fff]"
          >
            Eventos
          </Link>
          {user ? (
            ...
            <Link
              href="/login"
              data-cursor-hover
              className="rounded-full bg-[#f5f4f1] px-4 py-1.5 text-black transition duration-100 hover:bg-[#c3adff] active:scale-95"
            >
              Iniciar sesión
            </Link>
          )}
