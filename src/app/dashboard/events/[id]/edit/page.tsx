    ...
    <div className="mx-auto max-w-2xl">
      ...
      <Card className="mb-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <div>
            <p className="text-2xl font-bold text-[#C8FF3D]">
          ...
          <div className="flex items-end">
            <a
              ...
              className="inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-full border border-white/20 px-4 py-2 text-sm font-semibold text-[#f5f4f1] transition hover:border-[#DFFF8F] hover:text-[#DFFF8F]"
            >
